const Sobre = () => {
    return (
        <>
           <div className="flex flex-col items-center bg-gradient-to-b from-[#FEF2DC] to-[#ffffff] px-4 sm:px-8">

{/* Sobre Nós */}
<div className="w-full border-b-4 border-black rounded-2xl p-6 sm:p-10 bg-white shadow-2xl max-w-4xl mx-auto my-10 sm:my-16">
  <h1 className="text-center text-3xl sm:text-4xl md:text-5xl font-semibold text-black mb-6">
    Sobre Nós
  </h1>
  <p className="text-center text-base sm:text-lg leading-relaxed text-gray-700">
...
{/* Desenvolvedores */}
<div className="w-full border-b-4 border-black rounded-2xl p-6 sm:p-10 bg-white shadow-2xl max-w-6xl mx-auto my-10 sm:my-16">
  <h1 className="text-center text-3xl sm:text-4xl md:text-5xl font-semibold text-black mb-10">
    Desenvolvedores
  </h1>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10">
    ...
    <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl shadow-md">
      ...
      />
      <h2 className="text-lg sm:text-xl font-bold text-black">Cleyton Enrike</h2>
    ...
    <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl shadow-md">
      <img
        ...
        className="w-24 h-24 sm:w-28 sm:h-28 object-cover rounded-full mb-4"
      />
      <h2 className="text-lg sm:text-xl font-bold text-black">Matheus Henrique</h2>
      <p className="text-gray-600">Front-End Developer</p>
    </div>
    ...
    <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl shadow-md">
      <img
        ...
        className="w-24 h-24 sm:w-28 sm:h-28 object-cover rounded-full mb-4"
      />
      <h2 className="text-lg sm:text-xl font-bold text-black">Pedro Henrique</h2>
      <p className="text-gray-600">Front-End Developer</p>
    </div>
  </div>
</div>
